...
\ifthenelse{\equal{$lang$}{fr}}{\textbf{Préparation de document}}{\textbf{Document Preparation}}
\vspace{-.25cm}
...
$if(reviewer)$
\ifthenelse{\equal{$lang$}{fr}}{
  \section*{\textbf{Réviseur pour les jounaux à comité de lecture suivant:}}}{
